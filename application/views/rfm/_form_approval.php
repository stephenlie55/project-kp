...
<div class="modal-body">
    <form id="frm-app" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            < placeholder="Notes..." rows="2" class="form-control" readonly><?php echo $rows->approve_notes ?></>
        </div>
        <?php endif ?>
        ...
        <div class="form-group">
            ...
            <textarea placeholder="Notes..." rows="2" style="resize: none" class="form-control" readonly><?php echo $rows->receive_notes ?></textarea>
        </div>
        <?php endif ?>
